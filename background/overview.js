...
export const generateOverview = async (contentObj) => {
    ...
    // Count the number of words in the contentand return an object with the value
    ...
    // Return an object containing the overview word count
    return {  overviewWords: contentWords };
}